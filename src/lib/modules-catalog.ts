...
export const MODULES: ModuleDef[] = [
  ...
  { slug: "leakcheck-public", name: "LeakCheck Public",  category: "Breach",
    ...
    minTier: "Basic",
    provider: { kind: "leakcheck-public" } },
  { slug: "hudsonrock-domain", name: "Hudson Rock — Domain Infostealer", category: "Breach",
    description: "Free Hudson Rock infostealer check for a corporate domain. Surfaces employee/user infections.",
    inputLabel: "Domain", inputPlaceholder: "example.com",
    minTier: "Basic",
    provider: { kind: "public-get", urlTemplate: "https://cavalier.hudsonrock.com/api/json/v2/osint-tools/search-by-domain?domain={q}" } },
  ...
  { slug: "seon-phone", name: "SEON Phone Footprint", category: "Identity",
    ...
    inputLabel: "Phone (E.164)", inputPlaceholder: "+14155551234",
    minTier: "Investigator",
    provider: { kind: "seon-phone" } },

  // Identity — free public providers
  { slug: "emailrep", name: "EmailRep", category: "Identity",
    description: "Reputation, profile signals and social footprint for an email address.",
    inputLabel: "Email", inputPlaceholder: "target@example.com",
    minTier: "Basic",
    provider: { kind: "public-get", urlTemplate: "https://emailrep.io/{q}" } },
  { slug: "hudsonrock-email", name: "Hudson Rock — Email Infostealer", category: "Identity",
    description: "Free Hudson Rock check: is this email present in any infostealer corpus?",
    inputLabel: "Email", inputPlaceholder: "target@example.com",
    minTier: "Basic",
    provider: { kind: "public-get", urlTemplate: "https://cavalier.hudsonrock.com/api/json/v2/osint-tools/search-by-email?email={q}" } },
  { slug: "hudsonrock-username", name: "Hudson Rock — Username Infostealer", category: "Identity",
    description: "Free Hudson Rock check by username across infostealer corpora.",
    inputLabel: "Username", inputPlaceholder: "targetuser",
    minTier: "Basic",
    provider: { kind: "public-get", urlTemplate: "https://cavalier.hudsonrock.com/api/json/v2/osint-tools/search-by-username?username={q}" } },
  ...
  // Social — free public lookups
  { slug: "github-user", name: "GitHub User", category: "Social",
    description: "Public GitHub profile: bio, repos count, followers, location, company.",
    inputLabel: "GitHub username", inputPlaceholder: "torvalds",
    minTier: "Basic",
    provider: { kind: "public-get", urlTemplate: "https://api.github.com/users/{q}" } },
  { slug: "reddit-user", name: "Reddit User", category: "Social",
    description: "Public Reddit account metadata: karma, account age, verified email flag.",
    inputLabel: "Reddit username", inputPlaceholder: "spez",
    minTier: "Basic",
    provider: { kind: "public-get", urlTemplate: "https://www.reddit.com/user/{q}/about.json" } },

  // IP — free providers
  { slug: "ip-api", name: "IP-API Geo", category: "IP",
    description: "Free IP geolocation: country, region, city, ISP, ASN, proxy/hosting flags.",
    inputLabel: "IPv4 / IPv6", inputPlaceholder: "1.1.1.1",
    minTier: "Basic",
    provider: { kind: "public-get", urlTemplate: "http://ip-api.com/json/{q}?fields=66846719" } },
  { slug: "crtsh-domain", name: "crt.sh Subdomains", category: "IP",
    description: "Certificate-Transparency subdomain enumeration via crt.sh.",
    inputLabel: "Domain", inputPlaceholder: "example.com",
    minTier: "Investigator",
    provider: { kind: "public-get", urlTemplate: "https://crt.sh/?q=%25.{q}&output=json" } },
  { slug: "wayback", name: "Wayback Availability", category: "IP",
    description: "Most recent Internet Archive snapshot of a URL (proof-of-existence pivots).",
    inputLabel: "URL", inputPlaceholder: "https://example.com",
    minTier: "Basic",
    provider: { kind: "public-get", urlTemplate: "https://archive.org/wayback/available?url={q}" } },

  // Gaming — free
  { slug: "mojang-uuid", name: "Mojang UUID Lookup", category: "Gaming",
    description: "Resolve a Minecraft username to its current Mojang UUID.",
    inputLabel: "Minecraft username", inputPlaceholder: "Notch",
    minTier: "Basic",
    provider: { kind: "public-get", urlTemplate: "https://api.mojang.com/users/profiles/minecraft/{q}" } },
